...
from FaceDetection.pyimagesearch.face_blurring import anonymize_face_pixelate
from FaceDetection.pyimagesearch.face_blurring import anonymize_face_simple
...
# vs = VideoStream(src=r'C:\Users\sandeep.sharma\Downloads\Hindi romantic video short love song।.mp4',framerate=520).start()
time.sleep(2)
